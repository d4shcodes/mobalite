...
<section class=" bg-gradient-to-b from-green-50 to-green-100 py-10 sm:py-16 lg:py-24">
            ...
            <div>
                <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                    ...
                    <div class="relative inline-flex">
                        ...
                        <h1 class="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">MobaLite.
                        </h1>
                    </div>
                </h1>

                <p class="mt-8 text-base text-black sm:text-xl text-justify">Lorem ipsum dolor sit amet
                    consectetur adipisicing elit. Maxime mollitia,
                    molestiae quas vel sint commodi repudiandae, where is cole palmer ? ugiat iusto fuga
                    praesentium</p>

                <div class="mt-4 sm:flex sm:items-center sm:align-center sm:space-x-8">
                    <a href="#" title=""
                    ...
                    <a href="#" title=""
                        ...
                        <svg class="w-10 h-10 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
